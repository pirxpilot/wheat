...
var Renderers = module.exports = {
  index: Git.safe(function index(version, options, callback) {
    Step(
      function getHead() {
        Git.getHead(this);
      },
  ...
  feed: Git.safe(function feed(version, options, callback) {
    var articles;
    Step(
      function loadData() {
  ...
  sitemap: Git.safe(function feed(version, options, callback) {
    Step(
      function loadData() {
      ...
      function finish(err, buffer) {
        ...
        postProcess({
          ...
          "Cache-Control": "public, max-age=3600"
        }, buffer, version, "sitemap.xml", this);
      },
      callback
    );
  }),

  article: Git.safe(function renderArticle(version, name, options, callback) {
  ...
  categoryIndex: Git.safe(function index(version, category, options, callback) {
    Step(
      function getHead() {
        Git.getHead(this);
      },
  ...
  staticFile: Git.safe(function staticFile(version, path, options, callback) {
    Step(
  ...
  dotFile: Git.safe(function dotFile(version, path, options, callback) {
    Step(
      function loadPublicFiles() {
        Git.readFile(version, "skin/public/" + path, this);
      },
  ...
  page: Git.safe(function page(version, name, options, callback) {
    var page;
    Step(
      function loadData() {
        Git.getHead(this);
